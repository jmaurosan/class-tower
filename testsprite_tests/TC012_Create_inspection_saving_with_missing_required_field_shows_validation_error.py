...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login to reach the login page and continue the test flow.
        ...
        # -> Click on 'Vistorias' in the main navigation to open the inspections list (use nav button index 304).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/aside/nav/button[7]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Click on 'Vistorias' in the main navigation using the visible button at element index 694.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/aside/nav/button[7]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Click the 'Register new inspection' / 'Nova Vistoria' button to open the new-inspection form (use element index 1233).
        frame = context.pages[-1]
        # Click element
